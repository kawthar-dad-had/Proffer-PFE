...
export const Sider: typeof DefaultSider = ({ render }) => {
          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: isSelected? "#058760" : "transparent",
                  },
        ...
        <ListItemButton
          ...
          sx={{
            ...
            "&.Mui-selected": {
              ...
              backgroundColor: selectedKey === "/"? "primary.main" : "transparent",
            },
            justifyContent: "center",
          }}
        >
  ...
  const drawer = (
    <MuiList disablePadding sx={{ mt: 1, color: "secondary" }}>
      {renderSider()}
    </MuiList>
  );
  ...
  return (
    <>
      ...
      >
        ...
        >
          <IconButton
            sx={{ color: "success.main", width: "36px" }}
